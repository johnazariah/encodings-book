% Color support (needed for sample PDF gray ToC entries)
\usepackage{xcolor}
...
% Define abstract environment for book class (Pandoc expects it)
\makeatletter
\@ifundefined{abstract}{%
  \newenvironment{abstract}{\chapter*{Abstract}\small}{}%
}{}
\makeatother
